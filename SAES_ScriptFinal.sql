...
ALTER TABLE HORA_CLASE ADD CONSTRAINT PK_HORA_CLASE_GRUPO FOREIGN KEY (IdGrupo,CicloEscolar) REFERENCES GRUPO(IdGrupo,CicloEscolar);
ALTER TABLE HORA_CLASE ADD CONSTRAINT PK_HORA_CLASE_MATERIA FOREIGN KEY (IdMateria) REFERENCES MATERIA(IdMateria);
ALTER TABLE HORA_CLASE ADD CONSTRAINT PK_HORA_CLASE_MAESTRO FOREIGN KEY (IdMAESTRO) REFERENCES MAESTRO(IdMAESTRO);
...
/* REGISTROS DE TABLA: HORA_CLASE */

INSERT INTO HORA_CLASE (IdGrupo,CicloEscolar,IdMateria, IdMAESTRO) VALUES 
